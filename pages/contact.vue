<template>
  <div>
    ...
    <form netlify data-netlify="true" name="contact" method="POST" action="/pages/success">
      <div class="row">
        <div class="col-md-6">
